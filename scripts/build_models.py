...
from functions import (
    ...
    prune_causal_model, 
    refutability_test_I, 
    refutability_test_II, 
    edge_stability_test, 
    distributional_shift_test, 
    save_and_render_graph
)
...
model_II, adj_matrix_II, discarded_features, dataset_filtered = prune_causal_model(
    standardized_df_check, 
...
statistics = standardized_df_check[selected_features] \
    .describe() \
    .transpose()[['mean', 'std']] \
...
# #make a dictionary of selected features with corresponding mean, 
